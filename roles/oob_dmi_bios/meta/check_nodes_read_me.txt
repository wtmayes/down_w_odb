...
-	The seven .yml files, called in order from the role init update_oob_dmi_bios.yml,
...
-	Check if the memory and drives installed are complete and seen by bios
...
-	No need to make ssh connections to servers
   ...
   I’ll send out an updated consolidated list textfile as soon as I can corral the missing info.
